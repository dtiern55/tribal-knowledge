...
const THEMES: Record<Theme, PuzzleTheme> = {
  unlocked: {
    ...
    label: '#1e3a2f',
    frame: 'url("/wood-grain.svg") 0 0 / 320px 192px repeat, linear-gradient(158deg, #765235, #30190d)',
    frameShadow: 'inset 0 3px 0 rgba(255,225,180,0.10), inset 0 -8px 16px rgba(24,10,4,0.58), 0 34px 44px -12px rgba(62,32,15,0.55)',
    well: 'url("/wood-grain.svg") 0 0 / 240px 144px repeat, linear-gradient(158deg, #4b2e1b, #241107)',
  ...
  locked: {
    ...
    label: '#f2e9db',
    frame: 'url("/wood-grain.svg") 0 0 / 320px 192px repeat, linear-gradient(158deg, #edcf99, #a66f3b)',
    frameShadow: 'inset 0 3px 0 rgba(255,247,220,0.34), inset 0 -8px 16px rgba(91,52,22,0.38), 0 34px 48px -12px rgba(0,0,0,0.55)',
    well: 'url("/wood-grain.svg") 0 0 / 240px 144px repeat, linear-gradient(158deg, #bd884e, #70431f)',
